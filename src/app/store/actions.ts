...
const removeFromPrompt = createAction('Remove tag from prompt', props<{ value: string; isNegative: boolean }>());

const updateTagEmphasis = createAction('Update tag emphasis', props<Prompt>());
